...
select vorname, stadt, telefon from benutzer;
...
select nachname, vorname, telefon from benutzer where nachname like 'L%';

-- 8    Geben Sie alle Benutzer mit Nachname, Vornamen, Telefonnummer und deren Telefonnummer die Zahl 67 enhält.

select nachname, telefon, vorname from benutzer where telefon like '67';

-- 9    Geben Sie alle Benutzer mit Nachname, Vornamen, Telefonnummer und deren Telefonnummer mindestens die Ziffernfolge '02' zu Beginn der Vorwahl enthält.
select nachname, vorname, telefon From benutzer where telefon like '02';
...
update benutzer
    set mobile= '079 415 17 18'
    where nachname= 'Gamble';

-- 4   Der Benutzer mit Nachname Gamble ist von Irland nach 8810 Horgen an die Seestrasse 16 gezogen. Seine Telefon ist 044 720 15 16.

update benutzer
    set postleitzahl= '8810', stadt= 'Horgen', adresse1= 'Seestrasse 16', land= 'Swietzerland';
